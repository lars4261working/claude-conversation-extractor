...
STRINGS = {
    ...
    "ja": {
        "tool_title":        "Claude 会話エクスポーター",
        "reading":           "読み込み中",
        "total_convs":       "{n} 件の会話",
        "scanning":          "ファイルをスキャン中...",
        "found_files":       "{n} 件のファイル、{t} 種類を検出",
        "menu_1":            "1) ファイル抽出     拡張子でフィルタ (.md .py .html ...)",
        "menu_2":            "2) 会話を抽出       人間が読める形式 (Markdown)",
        "menu_3":            "3) 会話を抽出       プログラム用形式 (JSON)",
        "menu_4":            "4) すべて抽出       ファイル + 会話（両形式）",
        "menu_d":            "d) 日付プレフィックス 現在: [{s}]",
        "menu_l":            "l) 言語 Language     現在: [{s}]",
        "menu_q":            "q) 終了",
        "folder_example":    "フォルダ例:",
        "choose_prompt":     "選択 [1-4/d/l/q]: ",
        "invalid_choice":    "1-4、d、l、q のいずれかを入力してください",
        "date_on":           "オン",
        "date_off":          "オフ",
        "date_toggled":      "日付プレフィックスを{s}",
        "date_enabled":      "有効化しました",
        "date_disabled":     "無効化しました",
        "example_prefix":    "例:",
        "conv_range":        "会話の範囲を選択:",
        "conv_all":          "all        → すべて {n} 件の会話",
        "conv_list":         "list       → 全会話を一覧表示（日付付き）",
        "conv_num":          "番号入力   → 例: 1 5 10-20 200",
        "conv_q":            "q          → 戻る",
        "conv_prompt":       "選択: ",
        "conv_selected":     "{n} 件の会話を選択しました",
        "conv_invalid_range":"無効な範囲:",
        "conv_out_of_range": "範囲外:",
        "conv_invalid":      "無効な入力:",
        "conv_none":         "会話が選択されていません",
        "conv_total":        "{n} 件の会話",
        "file_types_title":  "会話に含まれるファイル種別",
        "ext_header":        "拡張子",
        "count_header":      "件数",
        "total_label":       "合計",
        "select_method":     "選択方法:",
        "sel_by_num":        "番号入力     → 例: 1 3 5",
        "sel_by_ext":        "拡張子入力   → 例: .md .py .html",
        "sel_all":           "all          → すべて",
        "sel_skip":          "q            → ファイル抽出をスキップ",
        "sel_prompt":        "抽出する種類を選択: ",
        "sel_chosen":        "選択: {s}（{n} 件のファイル）",
        "sel_confirm":       "確認? [Y/n]: ",
        "extracting":        "抽出開始:",
        "extract_together":  "会話ごとにフォルダを作成、すべてまとめて配置",
        "label_files":       "ファイル",
        "label_md":          "会話 (Markdown)",
        "label_json":        "会話 (JSON)",
        "done":              "完了！",
        "done_files":        "{n} 件のファイルを抽出",
        "done_md":           "{n} 件の会話 → _chat.md",
        "done_json":         "{n} 件の会話 → _chat.json",
        "output_dir":        "出力先:",
        "bye":               "終了！",
        "part_files":        "ファイル {n} 件({bd})",
        "part_chat":         "{n} 件のメッセージ",
        "no_title":          "無題",
        "readable_user":     "🧑 ユーザー",
        "readable_claude":   "🤖 Claude",
        "readable_created":  "作成日時",
        "readable_updated":  "更新日時",
        "readable_thinking": "💭 思考プロセス",
        "readable_tool_call":"🔧 ツール呼び出し",
        "readable_result":   "📋",
        "readable_error":    "❌ エラー",
        "readable_ok":       "✅ 結果",
        "readable_attach":   "📎 添付ファイル",
        "readable_file":     "📁 ファイル",
        "list_header_date":  "日付",
        "list_header_title": "タイトル",
    },
}
...
def show_main_menu():
    ...
    while True:
        ...
        if choice == 'd':
            ...
            continue
        if choice == 'l':
            cycle = {"zh": "en", "en": "ja", "ja": "zh"}
            LANG = cycle.get(LANG, "zh")
